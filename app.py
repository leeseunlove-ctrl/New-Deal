...
def main() -> None:
    ...
    st.markdown(
        ...
        [class*="st-key-api_key_field_valid"] input,
        [class*="st-key-agent_name_field_valid"] input {background:#f0fdf4 !important;}
        ...
        [class*="st-key-agent_name_field_invalid"] div[data-baseweb="input"] {
            border:2px solid #dc2626 !important; background:#fef2f2 !important;
        }
        [class*="st-key-api_key_field_invalid"] input,
        [class*="st-key-agent_name_field_invalid"] input {background:#fef2f2 !important;}
